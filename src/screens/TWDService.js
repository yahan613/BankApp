  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={{ width: '100%', height: 80, backgroundColor: '#244172', flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }}>
        ...
        <Text style={{ color: '#fff', fontSize: 20 }}>台幣服務</Text>
      </View>
        ...
        <View style={styles.box}>
          <View style={styles.labelContainer}>
            ...
            <TouchableOpacity style={{flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center'}}>
                <Text style={{flex: 1, ...Platform.select({ios: {fontSize: 14},android: {fontSize: 16}}) }}>查詢帳戶明細</Text>
          ...
          <View style={styles.labelContainer}>
            <View style={styles.label}>
            <TouchableOpacity style={{flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center'}}>
                <Text style={{flex: 1, ...Platform.select({ios: {fontSize: 14},android: {fontSize: 16}}) }}>查詢/取消預約轉帳</Text>
                {geticon('Arrow_forward_ios')}
            </TouchableOpacity>
            </View>
          </View>
          ...
          <View style={styles.labelContainer}>
            <View style={styles.label}>
              <TouchableOpacity style={{flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center'}}>
                <Text style={{flex: 1, ...Platform.select({ios: {fontSize: 14},android: {fontSize: 16}}) }}>定存</Text>
                {geticon('Arrow_forward_ios')}
              </TouchableOpacity>
            </View>
          </View>
